    ...
    export default {
        ...
        methods:{
                ...
                completeRequest: function (unicornResponse) {
                        ...
                        // Parsing the body of the response from a JSON string to a JavaScript object
                            var parsedResponse = JSON.parse(unicornResponse.body);

                            unicorn = parsedResponse.Unicorn;
